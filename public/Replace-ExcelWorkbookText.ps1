...
.EXAMPLE
	Replace-ExcelWorkbookText -Path "\\server123\docs" -SearchPattern "Server543" -ReplaceWith "Server9022" -Apply
...
.EXAMPLE
	Replace-ExcelWorkbookText -Path "\\server123\docs" -SearchPattern "Server543" -ReplaceWith "Server9022" -NoRecurse -Apply
...
.EXAMPLE
	$results = Replace-ExcelWorkbookText -Path "\\server123\docs" -SearchPattern "Server543" -ReplaceWith "Server9022"
	$results | Group-Object Workbook | Select-Object Count,Name

	Returns counts of matching instances by workbook filename
.LINK
	https://github.com/Skatterbrainz/helium/blob/master/docs/Replace-ExcelWorkbookText.md
#>
[CmdletBinding()]
param (
