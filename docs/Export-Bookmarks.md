...
```
Export-Bookmarks [[-InputFile] <string>] [[-OutputFile] <string>] [-Brave] [-Chrome] [-Edge]
 [-Firefox] [-All] [<CommonParameters>]
```
...
Optional.
Path to a bookmarks JSON file to export
...
Optional.
Path to save the exported HTML bookmarks file
