...
@{
	...
	PrivateData       = @{
		PSData = @{
			Tags                     = @('helium', 'windows', 'utility', 'skatterbrainz', 'url', 'ldap', 'grep', 'event', 'browser', 'profiles', 'chrome', 'firefox', 'edge', 'resource', 'sed', 'string', 'text', 'wlan', 'network', 'modules', 'linux', 'excel', 'phone', 'markdown')
