...
@{
    ...
    Copyright         = '(c) 2023-2025 Baron von Skattered McBrainzenHeliumhoffen. All rights reserved.'
    ...
    PrivateData       = @{
        PSData = @{
            Tags                     = @('helium', 'windows', 'utility', 'skatterbrainz', 'url', 'ldap', 'grep', 'event', 'browser', 'resource', 'sed', 'string', 'text', 'wlan', 'network', 'modules', 'linux', 'excel', 'phone')
